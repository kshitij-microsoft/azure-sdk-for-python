...
class AIProjectClient:  # pylint: disable=too-many-instance-attributes
    ...
    :ivar evaluation_suites: EvaluationSuitesOperations operations
    :vartype evaluation_suites: azure.ai.projects.aio.operations.EvaluationSuitesOperations
    ...
    def __init__(
        ...
        self.evaluation_suites = EvaluationSuitesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
