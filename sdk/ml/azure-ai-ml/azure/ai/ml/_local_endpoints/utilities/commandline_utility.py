...
def run_cli_command(
    ...
    try:
        ...
        # SECURITY FIX: Use argument list form instead of shell=True to prevent command injection.
        # Passing arguments as a list ensures special characters are not interpreted by the shell.
