...
from ...operations._endpoint_deployment_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_in_workspace_request, build_get_request, build_list_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class EndpointDeploymentOperations:
    """EndpointDeploymentOperations async operations.
    ...
    async def _create_or_update_initial(
        ...
        **kwargs: Any
    ) -> Optional["_models.EndpointDeploymentResourcePropertiesBasicResource"]:
