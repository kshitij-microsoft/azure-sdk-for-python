...
class ContentSafetyLevel(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DataGenerationTaskType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DataGenerationType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class DefaultActionType(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class FirewallSku(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ManagedNetworkKind(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ManagedNetworkProvisioningState(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SystemDatastoresAuthMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class VulnerabilityRisk(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
