...
from ...operations._serverless_endpoints_operations import build_create_or_update_request_initial, build_delete_request_initial, build_get_request, build_list_keys_request, build_list_request, build_regenerate_keys_request_initial, build_update_request_initial
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class ServerlessEndpointsOperations:
    """ServerlessEndpointsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.ServerlessEndpointTrackedResourceArmPaginatedResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.ServerlessEndpointTrackedResourceArmPaginatedResult]
