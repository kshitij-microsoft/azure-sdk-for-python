...
class AzureMachineLearningWorkspaces(object):    # pylint: disable=too-many-instance-attributes
    ...
    :vartype ptu_quota: azure.mgmt.machinelearningservices.operations.PTUQuotaOperations
    ...
    :vartype outbound_rule: azure.mgmt.machinelearningservices.operations.OutboundRuleOperations
    :ivar outbound_rules: OutboundRulesOperations operations
    :vartype outbound_rules: azure.mgmt.machinelearningservices.operations.OutboundRulesOperations
    ...
    :type base_url: str
    :keyword api_version: Api Version. The default value is "2025-04-01-preview". Note that
