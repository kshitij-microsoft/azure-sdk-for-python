...
class ConnectionRaiBlocklistsOperations:
    """ConnectionRaiBlocklistsOperations async operations.
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.RaiBlocklistPropertiesBasicResourceArmPaginatedResult"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.RaiBlocklistPropertiesBasicResourceArmPaginatedResult]
