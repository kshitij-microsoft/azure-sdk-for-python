...
### Tag: v2025-04-01-preview

These settings apply only when `--tag=v2025-04-01-preview` is specified on the command line.

```yaml $(tag) == 'v2025-04-01-preview'
input-file:
...
output-folder: $(python-sdks-folder)/v2025_04_01_preview
```
